...
var library = [
  ...
  {f: '(int)(t/10000000*t*t+t)%127|t>>4|t>>5|t%127+(t>>16)|t', tags: []},
  {f: '((t/2*(15&(591751328>>(t>>8&28))))|t/2>>(t>>11)^t>>12)+(t/16&t&24)', tags: []},
  ...
  {f: '((t*(t>>12)&(201*t/100)&(199*t/100))&(t*(t>>14)&(t*301/100)&(t*399/100)))+((t*(t>>16)&(t*202/100)&(t*198/100))-(t*(t>>18)&(t*302/100)&(t*298/100)))', tags: []},
  ...
  {f: '(t*t/256)&(t>>((t/1024)%16))^t%64*(0xC0D3DE4D69>>(t>>9&30)&t%32)*t>>18', tags: []},
  ...
  {f: 't*(0xCA98>>(t>>9&14)&15)|t>>8', tags: []},
  {f: '(t/8)>>(t>>9)*t/((t>>14&3)+4)', tags: []},
  {f: '(~t/100|(t*3))^(t*3&(t>>5))&t', tags: []},
  {f: 't&(sin(t&t&3)*t>>5)/(t>>3&t>>6)', tags: []},
  {f: '(t>>1)*(0xbad2dea1>>(t>>13)&3)|t>>5', tags: []},
  {f: '(t>>4)*(13&(0x8898a989>>(t>>11&30)))', tags: []},
  {f: '(t>>(t&7))|(t<<(t&42))|(t>>7)|(t<<5)', tags: []},
  {f: '(t>>7|t%45)&(t>>8|t%35)&(t>>11|t%20)', tags: []},
  {f: '(t>>6|t<<1)+(t>>5|t<<3|t>>3)|t>>2|t<<1', tags: []},
  {f: 't+(t&t^t>>6)-t*((t>>9)&(t%16?2:6)&t>>9)', tags: []},
  ...
  {f: 't>>4|t&DIV((t>>5),(t>>7-(t>>15)&-t>>7-(t>>15)))', tags: []},
  ...
  {f: '((t&4096)&&((t*(t^t%255)|(t>>4))>>1)||(t>>3)|((t&8192)&&t<<2||t))', tags: []},
  {f: '((t>>4)*(13&(0x8898a989>>(t>>11&30)))&255)+((((t>>9|(t>>2)|t>>8)*10+4*((t>>2)&t>>15|t>>8))&255)>>1)', tags: []},
...
export default class Manual extends React.Component {
  constructor() {
    ...
    this.onresize = () => {
      ...
      this.ellipsisWidth = this.width * 0.8;
  ...
  render() {
    ...
    for (var i = 0; i < library.length; i++) {
      results.push(<a href={'#' + encodeURIComponent(library[i].f)} style={{
	  display: 'block',
	  whiteSpace: 'nowrap',
	  overflow: 'hidden',
	  textDecoration: 'none',
