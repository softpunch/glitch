...
export default function Help() {
  return (<div style={helpStyle}>
    ...
    <p>- Any letter or word becomes a variable. `t` is special, it's
    increased on each iteration while other variables are preserved. `=` can
    be used to assign values to variables. `,` can be used to combine
    multiple expressions - the result is the result of the last expression,
    e.g. `a=6,b=a+1,a*b` returns 42.</p>
  </div>);
}
